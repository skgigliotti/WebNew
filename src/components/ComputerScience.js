    ...
    <div className="Page-all">
      ...
      <div className="Computer-science">
        <div className="Cs-projects Text-background">
          <h2>Projects</h2>
          <ul class="SG">
            <li class="sgLi">🍎  <a href="https://codeinplace.stanford.edu/" target="_blank">  Code in Place </a>  (Python) -  TA for online course offered by Stanford University during the COVID-19 pandemic that brought together 12,000 students and 1100 volunteer teachers participating from around the world.</li>
